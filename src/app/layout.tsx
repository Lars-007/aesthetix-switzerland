  ...
  return (
    <html lang="de" className={`${inter.variable} ${syne.variable}`}>
      <body className="bg-bg text-white antialiased font-sans">
        ...
        <Footer />
        {/* Global film grain — subtle premium texture across the whole site */}
        <div
          aria-hidden
          className="pointer-events-none fixed inset-0 z-[60] noise-overlay opacity-[0.025] mix-blend-overlay"
        />
      </body>
    </html>
  );
