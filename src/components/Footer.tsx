        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              <Link href="/products" className="text-sm text-white/65 hover:text-white transition-colors">Produkte</Link>
              <Link href="/#why" className="text-sm text-white/65 hover:text-white transition-colors">Über uns</Link>
              <Link href="/#faq" className="text-sm text-white/65 hover:text-white transition-colors">FAQ</Link>
              <Link href="/cart" className="text-sm text-white/65 hover:text-white transition-colors">Warenkorb</Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              <a href="mailto:info@aesthetix-switzerland.ch" className="text-sm text-white/65 hover:text-white transition-colors">info@aesthetix-switzerland.ch</a>
              <p className="text-sm text-white/65">Schweiz</p>
            </div>
          </div>
        </div>
